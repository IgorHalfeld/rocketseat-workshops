...
var coupon_querybuilder_1 = require("./coupon.querybuilder");
function apply(payload) {
    return __awaiter(this, void 0, void 0, function () {
        var Coupons, coupon, products;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    products = payload.products.map(function (product) {
                        ...
                        var finalPrice = product.price - (product.price * (coupon.amount / 100));
                        return __assign({}, product, { price: finalPrice });
                    });
